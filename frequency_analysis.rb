...
ciphertext = 'xultpaajcxitltlxaarpjhtiwtgxktghidhipxciwtvgtpilpitghlxiwiwtxgqa'\
  'dds'

analysis = FrequencyAnalysis.new(ciphertext: ciphertext)
analysis.print(sort: :alpha)
analysis.print(sort: :freq, freq: true)

ShiftCipher.decrypt(str: ciphertext, shift: 15)
